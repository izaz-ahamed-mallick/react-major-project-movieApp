...
const PersonDetails = () => {
    ...
    return info ? (
        <div className="w-full min-h-screen bg-[#1F1E24] text-white px-4 md:px-12">
            {/* Navigation */}
            ...
            <div className="flex flex-col md:flex-row w-full mt-4">
                ...
                <div className="w-full md:w-[25%] flex flex-col pl-0 md:pl-12 mb-4 md:mb-0">
                    <img
                    ...
                    <div className="flex gap-x-6 my-2 text-2xl justify-center md:justify-start">
                        <a
                            target="_blank"
                ...
                {/* Name & Details */}
                <div className="w-full md:w-[75%] ml-0 md:ml-[3%] text-zinc-400">
                    ...
                    <div className="flex items-center justify-between gap-4 mb-2">
                        <h1 className="mb-2  text-md sm:text-lg">Acting</h1>
                        <DropDown
                            title={"Filter"}
                            options={["tv", "movie"]}
