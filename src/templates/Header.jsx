...
const Header = ({ data }) => {
  ...
  return (
    <div
      ...
      className="w-full h-[65vh] flex flex-col justify-end mt-1"
    >
      <div className="p-[5%] w-[70%]">
        ...
        <Link to={`/${data.media_type}/details/${data.id}/trailer`} className="p-3 rounded-lg hover:bg-[#5b49d1] bg-[#6556CD] mt-2 block w-fit">
